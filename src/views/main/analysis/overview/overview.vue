<template>
  <div class="overview">
    ...
    <keyie-card title="技术栈">
      <keyie-text-link :text-arrs="technologyStacks" />
      <keyie-descriptions :column="2" :table-datas="dependencies" title="生产环境依赖" />
      <keyie-descriptions :column="2" :table-datas="devDependencies" title="开发环境依赖" />
    </keyie-card>
    <keyie-card title="项目结构">
      <div class="c-left">
        <keyie-code :code="projectDir" language="bash" />
      </div>
    </keyie-card>
    <keyie-card title="项目规范">
      <keyie-descriptions
        :column="1"
        :table-datas="[
...
import keyieDescriptions from '../../../../base-ui/descriptions'
import keyieTextLink from '../../../../base-ui/text-link'
import KeyieCode from '../../../../base-ui/code'
